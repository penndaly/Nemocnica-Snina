...
export const PLATFORM_CATALOG: Record<WearablePlatform, PlatformCatalogEntry> = {
  ...
  medtronic_cgm:     { platform: 'medtronic_cgm',     brand: 'Medtronic',         model: 'Guardian 4 CGM',         category: 'medical',  deviceType: 'cgm',        partnershipRequired: true,  manualUploadOnly: false, iosAppRequired: false },
