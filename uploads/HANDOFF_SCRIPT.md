...
**GitHub:** `https://github.com/penndaly/Nemocnica-Snina`
Clone: `git clone git@github.com:penndaly/Nemocnica-Snina.git`
**Package manager: always `pnpm`** — never `npm install` or `yarn` in this monorepo.
